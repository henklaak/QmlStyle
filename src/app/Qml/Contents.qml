...
Item {
    ...
    LsCheckBox { x:  953; y: 705; }
    LsCheckBox { x: 1010; y: 705; checked: true; }
    LsCheckBox { x: 1068; y: 705; checked: true; pressed: true; }

    LsProgressBar { x: 102; y: 804; width: 440; height: 23; minimumValue: 0; maximumValue: 100; value: slider.value;}
